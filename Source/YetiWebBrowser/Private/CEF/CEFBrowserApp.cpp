...
void FCEFBrowserApp::OnWebKitInitialized()
{

}

void FCEFBrowserApp::OnBrowserCreated(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefDictionaryValue> ExtraInfo)
{
	RenderProcessThreadCreatedDelegate.ExecuteIfBound(Browser, ExtraInfo);
}
