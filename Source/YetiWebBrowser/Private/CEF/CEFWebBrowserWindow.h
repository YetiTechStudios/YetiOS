	...
	, public TSharedFromThis<FCEFWebBrowserWindow>
{
	...
	friend class FYetiWebBrowserSingleton;

	// CreateWidget should only be called by the WebBrowserView
	friend class SYetiWebBrowserView;
...
public:
	...
	virtual EYetiWebBrowserDocumentState GetDocumentLoadingState() const override;
	...
	DECLARE_DERIVED_EVENT(FCEFWebBrowserWindow, IYetiWebBrowserWindow::FOnDocumentStateChanged, FOnDocumentStateChanged);
	virtual FOnDocumentStateChanged& OnDocumentStateChanged() override
	{
		return DocumentStateChangedEvent;
	}

	DECLARE_DERIVED_EVENT(FCEFWebBrowserWindow, IYetiWebBrowserWindow::FOnTitleChanged, FOnTitleChanged);
	virtual FOnTitleChanged& OnTitleChanged() override
	{
		return TitleChangedEvent;
	}

	DECLARE_DERIVED_EVENT(FCEFWebBrowserWindow, IYetiWebBrowserWindow::FOnUrlChanged, FOnUrlChanged);
	virtual FOnUrlChanged& OnUrlChanged() override
	{
		return UrlChangedEvent;
	}

	DECLARE_DERIVED_EVENT(FCEFWebBrowserWindow, IYetiWebBrowserWindow::FOnToolTip, FOnToolTip);
	virtual FOnToolTip& OnToolTip() override
	{
		return ToolTipEvent;
	}

	DECLARE_DERIVED_EVENT(FCEFWebBrowserWindow, IYetiWebBrowserWindow::FOnNeedsRedraw, FOnNeedsRedraw);
	...
	DECLARE_DERIVED_EVENT(FCEFWebBrowserWindow, IYetiWebBrowserWindow::FOnShowPopup, FOnShowPopup);
	virtual FOnShowPopup& OnShowPopup() override
	{
		return ShowPopupEvent;
	}

	DECLARE_DERIVED_EVENT(FCEFWebBrowserWindow, IYetiWebBrowserWindow::FOnDismissPopup, FOnDismissPopup);
...
private:
	...
	*/
	 ...
	 */
	bool RequestCreateWindow(const TSharedRef<IYetiWebBrowserWindow>& NewBrowserWindow, const TSharedPtr<IYetiWebBrowserPopupFeatures>& BrowserPopupFeatures);
...
private:
	...
	EYetiWebBrowserDocumentState DocumentState;
