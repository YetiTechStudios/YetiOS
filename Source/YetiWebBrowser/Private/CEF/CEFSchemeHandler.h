...
public:
	 ...
	 */
	void AddSchemeHandlerFactory(FString Scheme, FString Domain, IYetiWebBrowserSchemeHandlerFactory* WebBrowserSchemeHandlerFactory);
	 ...
	 */
	void RemoveSchemeHandlerFactory(IYetiWebBrowserSchemeHandlerFactory* WebBrowserSchemeHandlerFactory);
