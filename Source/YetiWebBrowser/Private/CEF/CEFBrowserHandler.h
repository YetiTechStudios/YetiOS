...
public:
	...
	{
		return OnBeforePopup(Browser, Frame, Target_Url, Target_Frame_Name, PopupFeatures, WindowInfo, Client, Settings, ExtraInfo, no_javascript_access);
	}
...
public:
	...
	IYetiWebBrowserWindow::FOnBeforePopupDelegate& OnBeforePopup()
	{
		return BeforePopupDelegate;
	}

	IYetiWebBrowserWindow::FOnCreateWindow& OnCreateWindow()
	{
...
private:
	...
	IYetiWebBrowserWindow::FOnBeforePopupDelegate BeforePopupDelegate;
	
	/** Delegate for handling requests to create new windows. */
	IYetiWebBrowserWindow::FOnCreateWindow CreateWindowDelegate;
