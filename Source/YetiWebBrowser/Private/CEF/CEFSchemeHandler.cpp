...
#include "IYetiWebBrowserSchemeHandler.h"

#if WITH_CEF3

class FHandlerHeaderSetter
	: public IYetiWebBrowserSchemeHandler::IHeaders
{
public:
...
{
public:
	FCefSchemeHandler(TUniquePtr<IYetiWebBrowserSchemeHandler>&& InHandlerImplementation)
...
private:
	TUniquePtr<IYetiWebBrowserSchemeHandler> HandlerImplementation;
...
public:
	...
	FCefSchemeHandlerFactory(IYetiWebBrowserSchemeHandlerFactory* InWebBrowserSchemeHandlerFactory)
	...
	bool IsUsing(IYetiWebBrowserSchemeHandlerFactory* InWebBrowserSchemeHandlerFactory)
	{
		return WebBrowserSchemeHandlerFactory == InWebBrowserSchemeHandlerFactory;
	}

private:
	IYetiWebBrowserSchemeHandlerFactory* WebBrowserSchemeHandlerFactory;

	// Include CEF ref counting.
	IMPLEMENT_REFCOUNTING(FCefSchemeHandlerFactory);
};

void FCefSchemeHandlerFactories::AddSchemeHandlerFactory(FString Scheme, FString Domain, IYetiWebBrowserSchemeHandlerFactory* WebBrowserSchemeHandlerFactory)
{
...
void FCefSchemeHandlerFactories::RemoveSchemeHandlerFactory(IYetiWebBrowserSchemeHandlerFactory* WebBrowserSchemeHandlerFactory)
{
	checkf(WebBrowserSchemeHandlerFactory != nullptr, TEXT("WebBrowserSchemeHandlerFactory must be provided."));
