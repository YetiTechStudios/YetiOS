...
#include "../../../UE_4.25/Engine/Source/Runtime/CoreUObject/Public/UObject/Field.h"
...
{
public:
	FYetiWebJSScripting(bool bInJSBindingToLoweringEnabled)
	...
	virtual void InvokeJSFunction(FGuid FunctionId, int32 ArgCount, FYetiWebJSParam Arguments[], bool bIsError=false) =0;
