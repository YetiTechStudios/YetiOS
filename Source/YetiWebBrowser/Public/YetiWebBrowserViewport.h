 ...
 */
class YETIWEBBROWSER_API FYetiWebBrowserViewport : public ISlateViewport
{
public:
	/**
	 * Default Constructor
	 ...
	 */
	FYetiWebBrowserViewport(TSharedPtr<IYetiWebBrowserWindow> InWebBrowserWindow, bool InIsPopup = false)
...
private:
	...
	TSharedPtr<IYetiWebBrowserWindow>	WebBrowserWindow;
