 ...
 */
class YETIWEBBROWSER_API IYetiWebBrowserSchemeHandler
{
public:
	/**
...
public:
	virtual ~IYetiWebBrowserSchemeHandler() {}
 ...
 */
class YETIWEBBROWSER_API IYetiWebBrowserSchemeHandlerFactory
{
public:
	virtual ~IYetiWebBrowserSchemeHandlerFactory() {}
	 ...
	 * @param   Url             This is the full url for the request being made.
	 */
	virtual TUniquePtr<IYetiWebBrowserSchemeHandler> Create(FString Verb, FString Url) = 0;
};
