...
class YETIWEBBROWSER_API SYetiWebBrowser
	: public SCompoundWidget
{
public:
	DECLARE_DELEGATE_RetVal_TwoParams(bool, FOnBeforeBrowse, const FString&, const FYetiWebNavigationRequest& /*Request*/)
	...
	SLATE_BEGIN_ARGS(SYetiWebBrowser)
...
private:
	...
	TSharedPtr<SYetiWebBrowserView> BrowserView;
