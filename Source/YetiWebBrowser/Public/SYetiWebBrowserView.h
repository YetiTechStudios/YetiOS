...
class FYetiWebBrowserViewport;
class IYetiWebBrowserAdapter;
class IYetiWebBrowserDialog;
class IYetiWebBrowserPopupFeatures;
class IYetiWebBrowserWindow;
struct FYetiWebNavigationRequest;
enum class EYetiWebBrowserDialogEventResponse;
enum class EYetiWebBrowserDocumentState;

DECLARE_DELEGATE_RetVal_TwoParams(bool, FOnBeforePopupDelegate, FString, FString);
DECLARE_DELEGATE_RetVal_TwoParams(bool, FOnCreateWindowDelegate, const TWeakPtr<IYetiWebBrowserWindow>&, const TWeakPtr<IYetiWebBrowserPopupFeatures>&);
DECLARE_DELEGATE_RetVal_OneParam(bool, FOnCloseWindowDelegate, const TWeakPtr<IYetiWebBrowserWindow>&);
...
class YETIWEBBROWSER_API SYetiWebBrowserView
	: public SCompoundWidget
{
public:
	DECLARE_DELEGATE_RetVal_TwoParams(bool, FOnBeforeBrowse, const FString& /*Url*/, const FYetiWebNavigationRequest& /*Request*/)
	DECLARE_DELEGATE_RetVal_ThreeParams(bool, FOnLoadUrl, const FString& /*Method*/, const FString& /*Url*/, FString& /* Response */)
	DECLARE_DELEGATE_RetVal_OneParam(EYetiWebBrowserDialogEventResponse, FOnShowDialog, const TWeakPtr<IYetiWebBrowserDialog>&);
	...
	SLATE_BEGIN_ARGS(SYetiWebBrowserView)
	...
	{ }
		...
		SLATE_ARGUMENT(TOptional<FYetiBrowserContextSettings>, ContextSettings)
	 ...
	 */
	void Construct(const FArguments& InArgs, const TSharedPtr<IYetiWebBrowserWindow>& InWebBrowserWindow = nullptr);
	...
	*/
	...
	void BindAdapter(const TSharedRef<IYetiWebBrowserAdapter>& Adapter);

	void UnbindAdapter(const TSharedRef<IYetiWebBrowserAdapter>& Adapter);
...
private:
	...
	void HandleBrowserWindowDocumentStateChanged(EYetiWebBrowserDocumentState NewState);
	 ...
	 */
	bool HandleBeforeNavigation(const FString& Url, const FYetiWebNavigationRequest& Request);
	 ...
	 */
	bool HandleCreateWindow(const TWeakPtr<IYetiWebBrowserWindow>& NewBrowserWindow, const TWeakPtr<IYetiWebBrowserPopupFeatures>& PopupFeatures);
	 ...
	 */
	bool HandleCloseWindow(const TWeakPtr<IYetiWebBrowserWindow>& BrowserWindow);

	/** Callback for showing dialogs to the user */
	EYetiWebBrowserDialogEventResponse HandleShowDialog(const TWeakPtr<IYetiWebBrowserDialog>& DialogParams);
...
private:
	...
	TSharedPtr<IYetiWebBrowserWindow> BrowserWindow;
